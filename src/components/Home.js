                        ...
                        <View style={[styles.bg_White, styles.Width_100, styles.Border, styles.border_dash, styles.overHidden]}>
                            ...
                            <View style={[styles.paddingHorizontal_5]}>
                                <View style={[styles.rowGroup]}>
                                    <Text style={[styles.FairuzBold, styles.text_orange, styles.textSize_14,]} numberOfLines={1} ellipsizeMode='tail'>
                                        {item.title}
                                    </Text>
                                </View>
                                <View style={[styles.rowGroup, styles.marginVertical_5]}>
                                    <Text style={[styles.FairuzBold, styles.text_default_2, styles.textSize_13]}>
                                        {item.price} {i18n.t('ria')}
                                    </Text>
                                </View>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('detailsAdv', { blog_id: item.id })} style={[styles.Width_100, styles.flexCenter, styles.marginVertical_5]}>
                        <View style={[styles.bg_White, styles.Width_100, styles.rowIng, styles.Border, styles.border_dash, styles.overHidden]}>
                            ...
                            <View style={[styles.flex_70, styles.paddingHorizontal_5]}>
                                <View style={[styles.rowGroup]}>
                                    <Text style={[styles.FairuzBold, styles.text_orange, , styles.textSize_14, styles.width_100, styles.textDir]} numberOfLines={1} ellipsizeMode='tail'>
                                        {item.title}
                                    </Text>
                                                        ...
                                                        array.map((cate, index) => {
                                                            return (
                                                                <TouchableOpacity
                                                                    ...
                                                                    style={[styles.paddingHorizontal_15, styles.Border, styles.paddingVertical_5, styles.marginHorizontal_10, categoryId === cate.id ? [styles.border_default, styles.bg_default_2] : [styles.border_orange], { borderRadius: 5 }]}>
                                                                    <Text style={[styles.FairuzNormal, styles.textSize_14, categoryId === cate.id ? styles.text_default : styles.text_orange]}>
                                                                        {cate.name}
                                                                    </Text>
                                                                </TouchableOpacity>
                                                            )
